...
Faits bruts : Création du code-barre, exposition Feux Pâles (1990-1991), exposition L'Ombre du jaseur (2014).
Neutre : La story ne prend pas parti, elle décrit les événements.


Plot (Interprétation) :

Quatre interprétations distinctes de la même story :

CAPC : Exposition standard.
Claire Burrus : Œuvre non reproductible.
Emeline Jaret : Reconstitution possible avec documentation.
MAMCO : Adaptation libre.

Coexistence : Les plots ne se contredisent pas, ils offrent des perspectives différentes.


Narrative (Présentation) :

Exposition Feux Pâles (1990-1991) : Présente la story avec le plot du CAPC.
Exposition L'Ombre du jaseur (2014) : Présente la story avec le plot du MAMCO.


Liens avec le fictionnalisme :

Le code-barre et le livre de Nabokov sont liés au concept de fictionnalisme (P129_is_about).
...
ZE4_Classificatory_Status : Chaque attribution est liée à un sujet, un acteur, un type, et une période.

Exemple 1 : Feux Pâles est classé comme "Œuvre non reproductible" par Claire Burrus en 2017.
Exemple 2 : Le code-barre est "signé par le CAPC" et "conçu par Thomas" en 1990.

Coexistence : Les attributions ne se contredisent pas, car elles sont situées dans leur contexte.

===vvvvvv===
et pour le code bare embleme fictionaliste
...
### Artefact n°3 — *Klappensonnenuhr* [Portable sundial]
