...
*iArtHist Lab, Valencia University*
</div> <div class="card">
...
*Ouvroir Lab, University of Montreal*
</div> <div class="card">

**AAAo** Institutional-fact model for difficult historical data.
*Sari and TakinSolutions*
</div> </div> <br/>

/** Notes **/

@todo : add creators and links

This landscape of Ontologies is the one I am working on. CIDOC-CRM, LRMoo, Curate, and AAAo are the ones I will return to in the following slides.

I use CIDOC-CRM as the heritage ontological foundation. LRMoo models the Work/Expression/Manifestation/Item hierarchy of a work. Curate structures narrative discourse by separating story from plot. AAAo, the Art and Architecture Argumentation Ontology, models situated belief. OntoExhibit and Display round out this landscape; for lack of time, I will not go into them today.
