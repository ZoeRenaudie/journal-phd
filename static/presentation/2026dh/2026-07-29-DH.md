...
And one could argue that the most **unruly** medium in contemporary art could be the exhibition itself. 
So I have been working for a decade now on its documentation and here are some propositions. 
...
All of this work is documented in a repository, where you'll find my dataset and the modeling steps. I'll make it public soon, after peer evaluation (hit me if you are interested in participating).
