...
**Séminaire de muséologie MSL6526** Université de Montréal | Projet Forward Linking
25 juin 2026
...
Je vais commencer par une question qui peut sembler triviale : à quoi sert une fiche d'oeuvre, une notice dans un catalogue de gestion ?
...
Le GRASAC researchers from Indigenous communities, universities, museums and archives have worked together to locate, study, and create deeper understandings of Great Lakes arts, languages, identities, territoriality and governance.
...
Qu'est ce qu'elle a de particulier cette collection ? Quelle documentation vous attendez vous à trouver ? 
...
Discussion : 
est-ce que vous distinguez ce qu'on pourrait faire pour un changement de titre dans les cartels vocabulaires offensants : que faire ? 
