...
Le vision-language model (VLM) est un modèle d'IA qui traite conjointement des données visuelles et textuelles pour comprendre, relier ou générer du contenu multimodal (Kotsiantis et al., 20264).(Kotsiantis et al., 2026 [^5]).
